...
uint32_t T_S1_DOWN = 5000; // [ms] Tiempo entre piezas
uint32_t T_S2_UP = 100; // [ms] Tiempo para detección de pieza
uint32_t T_S2_DOWN = 5000; // [ms] Tiempo entre piezas
 // INCLUDE
// #include <SPI.h>
// #include <Ethernet.h>
...
Serial.println("?SENSOR/1;CTM_VALOR/-1;TOTAL/0");
